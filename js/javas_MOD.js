...
function check_1(_0xf288x11) {
    document.getElementById(_0xf288x11).onclick = function () {
        if (document.getElementById(_0xf288x11).checked) {
            localStorage.setItem(_0xf288x11, 'true');
            return 1
        } else {
            localStorage.setItem(_0xf288x11, 'false');
            return 0
        }
    };
    if (localStorage.getItem(_0xf288x11) == 'true') {
...
function Menu() {
    ...
    document.getElementById('background').onclick = function () {
        ...
        localStorage.setItem('background', _0xf288x18)
    };
    if (localStorage.getItem('background') > '0') {
        var _0xf288x19 = document.querySelector('#background');
        var _0xf288x1a = localStorage.getItem('background');
        switch (_0xf288x1a) {
        case '0':
            document.body.style.backgroundColor = '#21252c';
            break;
    ...
    if (localStorage.getItem('obrez') >= 0) {
...
function TradingView_11() {
    ...
    console.log(pair2);
    var _0xf288x1c = pair2;
    var _0xf288x1d = _0xf288x1c.replace('/', '');
    res = _0xf288x1d.replace('frx', '');
...
var Sign = function () {
        ...
        for (var _0xf288x35 = 0; _0xf288x35 < _0xf288x56; _0xf288x35++) {
            ...
            if (Strelki_On == 1) {
                if (_0xf288x35 == 1) {
                    ...
                    arrow_down_x = _0xf288x5f, arrow_down_y = _0xf288x60 + 330;
                    _0xf288x2b.font = ur_str_size + 'px Verdana';
                    if (color_text == '#d75c48') {
                        ArrowDraw(_0xf288x2b, 'up', _0xf288x61, _0xf288x62, 150, 150, 'green', 1, 'str');
                        ArrowDraw(_0xf288x2b, 'down', arrow_down_x, arrow_down_y, 150, 150, 'red', 1, 'fill');
                        _0xf288x2b.fillText(_0xf288x5a, _0xf288x61 + 30, arrow_down_y / 1.6);
                        if (strelki_procent == 1) {
                            _0xf288x2b.fillStyle = '#fff';
                            _0xf288x2b.fillText(rash_down + '%', _0xf288x61 + 50, arrow_down_y / po_up * 1.5);
                            _0xf288x2b.fillText(rash_up + '%', _0xf288x61 + 50, arrow_down_y / po_up)
                        }
                    } else {
                        if (color_text == '#008f1d') {
                            ArrowDraw(_0xf288x2b, 'up', _0xf288x61, _0xf288x62, 150, 150, 'green', 1, 'fill');
                            ArrowDraw(_0xf288x2b, 'down', arrow_down_x, arrow_down_y, 150, 150, 'red', 1, 'str');
                            _0xf288x2b.fillText(_0xf288x5a, _0xf288x61 + 30, arrow_down_y / 1.6);
                            if (strelki_procent == 1) {
                                _0xf288x2b.fillStyle = '#fff';
                                _0xf288x2b.fillText(rash_down + '%', _0xf288x61 + 50, arrow_down_y / po_up * 1.5);
        ...
        if (_0xf288x3e.time) {
            ...
            if (_0xf288x2f == 0 || Math.floor(_0xf288x3e.time / _0xf288x20.data.barsize) > Math.floor(_0xf288x20.data.data[0].time / _0xf288x20.data.barsize)) {
                if (_0xf288x3e.time > _0xf288x23) {
                    ...
                    localStorage.setItem('data', JSON.stringify(_0xf288x20.data))
                }
            } else {
                if (_0xf288x3e.close) {
                    _0xf288x24 = 0;
            ...
            if (_0xf288x3e.data) {
                if (!_0xf288x22) {
                    var _0xf288x68 = JSON.parse(localStorage.getItem('data'));
                    if (_0xf288x68) {
    ...
    this.pairchange = function () {
        ...
        _0xf288x24 = 0;
        localStorage.setItem('dsav', JSON.stringify(_0xf288x65));
        _0xf288x20.soc($('#pair').attr('val'), $('#size').val())
    };
    ...
    _0xf288x2c = JSON.parse(localStorage.getItem('dsav'));
